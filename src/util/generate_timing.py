...
# wgs 1.1.2
for f in glob.glob('CMHS[0-9]*.wgs.1.1.2.*.log.out'):
  fields = f.split('.')
  sample = fields[0]
  job = fields[2]
  started = None
...
# wgs
for f in glob.glob('CMHS[0-9]*.wgs.[a-z]*.log.out'):
  fields = f.split('.')
  sample = fields[0]
  job = fields[2]
  started = None
...
# gridss
for f in glob.glob('CMHS[0-9]*.gridss.log.err'):
  fields = f.split('.')
  sample = fields[0]
  job = 'gridss'
  started = None
...
# platypus
for f in glob.glob('CMHS[0-9]*.platypus.log.out'):
  fields = f.split('.')
  sample = fields[0]
  job = 'platypus'
  started = None
...
# mutect1
for f in glob.glob('CMHS[0-9]*.mutect1.log.out'):
  fields = f.split('.')
  sample = fields[0]
  job = 'mutect1'
  started = None
...
# mutect2
for f in glob.glob('CMHS[0-9]*.mutect2.log.out'):
  fields = f.split('.')
  sample = fields[0]
  job = 'mutect2'
  started = None
...
# muse
for f in glob.glob('CMHS[0-9]*.muse.log.out'):
  fields = f.split('.')
  sample = fields[0]
  job = 'muse'
  started = None
